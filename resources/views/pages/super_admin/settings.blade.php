                ...
                <div class="col-md-6 border-right-2 border-right-blue-400">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="Choose..." required name="current_session" id="current_session" class="select-search form-control">
                                    ...
                                    @for($y = $fromYear; $y <= $toYear; $y++)
                                        ...
                                        <option value="{{ $session }}" {{ ($s['current_session'] == $session) ? 'selected' : '' }}>{{ $session }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="province" value="{{ $s['province'] ?? 'KINSHASA' }}" type="text" class="form-control" placeholder="Ex: KINSHASA">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Ville</label>
                            <div class="col-lg-9">
                                <input name="city" value="{{ $s['city'] ?? '' }}" type="text" class="form-control" placeholder="Ex: Kinshasa">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Commune</label>
                            <div class="col-lg-9">
                                <input name="commune" value="{{ $s['commune'] ?? '' }}" type="text" class="form-control" placeholder="Ex: Lemba">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Code École</label>
                            <div class="col-lg-9">
                                <input name="school_code" value="{{ $s['school_code'] ?? '' }}" type="text" class="form-control" placeholder="Ex: KIN/LEMBA/001">
                            </div>
                        </div>
                    </fieldset>
                </div>

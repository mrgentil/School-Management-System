...
<div class="modal fade" id="notifyParentsModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('exam_analytics.send_parent_notifications') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group" id="schedule_options" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="date" name="schedule_date" class="form-control" min="{{ date('Y-m-d') }}">
                            </div>
                            <div class="col-md-6">

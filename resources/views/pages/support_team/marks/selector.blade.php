<form method="post" action="{{ route('marks.selector') }}">
        ...
        <div class="row">
            <div class="col-md-10">
                <fieldset>
                    {{-- Première ligne: Type d'évaluation et Période --}}
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        {{-- Champ pour la cote de l'interrogation (seulement pour interrogations) --}}
                    ...
                    {{-- Deuxième ligne: Classe et Matière --}}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    {{-- Troisième ligne: Examen/Devoir et Configuration --}}
                    <div class="row">
                        <div class="col-md-6">
                            {{-- Sélecteur d'examen (pour examens semestriels) --}}
                            ...
                            {{-- Sélecteur de devoir (pour devoirs) --}}

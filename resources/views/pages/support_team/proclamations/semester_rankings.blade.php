<div class="card">
    <div class="card-header">
        <h4 class="card-title">
            ...
            Proclamation Semestre {{ $semester }} - {{ $selected_class->full_name ?: $selected_class->name }}
        </h4>
    ...
    <div class="card-body">
        @if($rankings['total_students'] > 0)
            ...
            <div class="alert alert-info mb-4">
                ...
                Moyenne des périodes {{ $semester == 1 ? '1 et 2' : '3 et 4' }} (40%) + Examens semestre {{ $semester }} (60%)
            </div>
                            ...
                            <tr class="{{ $ranking['rank'] <= 3 ? 'table-warning' : '' }}">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-outline-info" 
                                            onclick="showStudentDetail({{ $ranking['student_id'] }}, '{{ $ranking['student_name'] }}', 'semester', {{ $semester }})">
                                        <i class="icon-eye"></i>
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <button class="btn btn-outline-primary" onclick="exportToPDF('semester', {{ $semester }})">

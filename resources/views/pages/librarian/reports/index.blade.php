...
@section('page_title', 'Rapports et Statistiques')
@section('content')
    ...
    <div class="card-header header-elements-inline bg-teal-400">
        ...
        <div class="header-elements">
            <span class="badge badge-light badge-pill px-3 py-2">
                Période : {{ \Carbon\Carbon::now()->format('F Y') }}
            </span>
        </div>
    </div>
</div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.reports.popular-books') }}" class="btn btn-success btn-block">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.reports.active-students') }}" class="btn btn-info btn-block">
                    <i class="icon-eye mr-2"></i> Voir le rapport
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.reports.monthly') }}" class="btn btn-warning btn-block">
                    <i class="icon-eye mr-2"></i> Voir le rapport
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.reports.inventory') }}" class="btn btn-primary btn-block">
                    <i class="icon-eye mr-2"></i> Voir le rapport
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.reports.penalties') }}" class="btn btn-danger btn-block">
                    <i class="icon-eye mr-2"></i> Voir le rapport
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card report-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('librarian.dashboard') }}" class="btn btn-teal btn-block">

<script>
    ...
    toastr.error('{{ session('pop_error') }}', 'Erreur!');
    @endif

    @if (session('pop_warning'))
    toastr.warning('{{ session('pop_warning') }}', 'Attention!');
    @endif

    @if (session('pop_success'))
    toastr.success('{{ session('pop_success') }}', 'Succès!');
    @endif

    @if (session('flash_info'))
    toastr.info('{{ session('flash_info') }}', 'Information');
    @endif

    @if (session('flash_success'))
    toastr.success('{{ session('flash_success') }}', 'Succès!');
    @endif

    @if (session('flash_warning'))
    toastr.warning('{{ session('flash_warning') }}', 'Attention!');
    @endif

    @if (session('flash_error') || session('flash_danger'))
    toastr.error('{{ session('flash_error') ?: session('flash_danger') }}', 'Erreur!');
    @endif

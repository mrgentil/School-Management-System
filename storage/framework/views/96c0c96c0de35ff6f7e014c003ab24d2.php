<table class="table table-bordered table-responsive text-center">
    ...
    <tr>
        ...
        <th rowspan="2">P1<br>(20)</th>
        <th rowspan="2">P2<br>(20)</th>
        ...
        <th rowspan="2">RANG<br>MATIÈRE</th>
    ...
    <tr class="bg-light font-weight-bold">
        <td colspan="4"><strong>TOTAL DES POINTS : </strong> <?php echo e($exr->total); ?></td>
        <td colspan="3"><strong>MOYENNE FINALE : </strong> <?php echo e($exr->ave); ?>%</td>
        <td colspan="2"><strong>MOYENNE DE CLASSE : </strong> <?php echo e($exr->class_ave); ?>%</td>
    </tr>
    </tbody>
</table>
<?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/marks/show/sheet.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page_title', 'Informations Étudiants - '.Qs::getFullClassName((object)['my_class' => $my_class])); ?>
                    ...
                    <table class="table datatable-button-html5-columns">
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><strong><?php echo e(Qs::getFullClassName($s)); ?></strong></td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <?php if(Qs::userIsTeamSA()): ?>
                                                    ...
                                                    <a href="<?php echo e(route('st.reset_pass', Qs::hash($s->user->id))); ?>" class="dropdown-item"><i class="icon-lock"></i> Réinitialiser mot de passe</a>
                                                <?php endif; ?>
                                                <a target="_blank" href="<?php echo e(route('marks.year_selector', Qs::hash($s->user->id))); ?>" class="dropdown-item"><i class="icon-check"></i> Bulletin de notes</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/students/list.blade.php ENDPATH**/ ?>
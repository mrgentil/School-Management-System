...
<?php $__env->startSection('page_title', 'Proclamations RDC'); ?>
    ...
    <div class="content-header header-elements-md-inline">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="btn-group float-md-right">
                <span class="badge badge-info">Session: <?php echo e($current_year); ?></span>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#proclamation-form').on('submit', function(e) {
        ...
        let url = '';
        if (type === 'period') {
            url = '<?php echo e(route("proclamations.period")); ?>';
        } else if (type === 'semester') {
            url = '<?php echo e(route("proclamations.semester")); ?>';
        }
    ...
    $('#recalculate-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("proclamations.recalculate")); ?>',
            method: 'POST',
            data: formData,
            beforeSend: function() {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/proclamations/index.blade.php ENDPATH**/ ?>
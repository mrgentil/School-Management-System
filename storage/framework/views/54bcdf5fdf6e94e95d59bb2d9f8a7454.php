            ...
            <table class="table table-bordered">
                <thead class="bg-primary text-white">
                    <tr>
                        ...
                        <?php else: ?>
                            <th class="text-center"><?php echo e($semester == 1 ? 'P1' : 'P3'); ?></th>
                            <th class="text-center"><?php echo e($semester == 1 ? 'P2' : 'P4'); ?></th>
                ...
                <tbody>
                    <?php $__currentLoopData = $bulletinData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($type == 'period'): ?>
                                <td class="text-center"><strong><?php echo e($data['total_obtained'] ?? 0); ?></strong></td>
                                <td class="text-center"><?php echo e($data['total_max'] ?? 20); ?></td>
                            <?php else: ?>
                                <?php
                                    $p1Key = $semester == 1 ? 'p1' : 'p3';
                                    $p2Key = $semester == 1 ? 'p2' : 'p4';
                                    $p1Max = $data[$p1Key . '_max'] ?? $data['period_max'] ?? 20;
                                    $p2Max = $data[$p2Key . '_max'] ?? $data['period_max'] ?? 20;
                                ?>
                                <td class="text-center"><?php echo e($data[$p1Key] ?? 0); ?>/<?php echo e($p1Max); ?></td>
                                <td class="text-center"><?php echo e($data[$p2Key] ?? 0); ?>/<?php echo e($p2Max); ?></td>
                                <td class="text-center"><?php echo e($data['exam'] ?? 0); ?>/<?php echo e($data['exam_max'] ?? 40); ?></td>
                                <td class="text-center"><strong><?php echo e($data['total_obtained'] ?? 0); ?>/<?php echo e($data['total_max'] ?? 80); ?></strong></td>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/bulletins/preview.blade.php ENDPATH**/ ?>
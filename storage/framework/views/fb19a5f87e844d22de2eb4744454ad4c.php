...
<?php $__env->startSection('page_title', 'Sauvegarde Base de Données'); ?>
...
<div class="card bg-primary text-white mb-3">
    <div class="card-body py-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="<?php echo e(route('backup.create')); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="col-md-4">
        <div class="card bg-info text-white">
            <div class="card-body text-center py-3">
                ...
                <h3 class="mb-0"><?php echo e($stats['total_backups']); ?></h3>
    ...
    <div class="col-md-4">
        <div class="card bg-success text-white">
            <div class="card-body text-center py-3">
                ...
                <h3 class="mb-0"><?php echo e($stats['total_size'] > 0 ? round($stats['total_size'] / 1024 / 1024, 2) : 0); ?> MB</h3>
    ...
    <div class="col-md-4">
        <div class="card bg-warning text-white">
            <div class="card-body text-center py-3">
                ...
                <h3 class="mb-0"><?php echo e($stats['last_backup'] ?? 'Aucun'); ?></h3>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-info"><?php echo e($backup['size']); ?></span>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="<?php echo e(route('backup.restore', $backup['name'])); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form action="<?php echo e(route('backup.destroy', $backup['name'])); ?>" method="POST" style="display: inline;">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/backup/index.blade.php ENDPATH**/ ?>
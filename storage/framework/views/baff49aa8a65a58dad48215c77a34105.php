        ...
        <form class="ajax-store" method="post" action="<?php echo e(route('tt.store')); ?>">
            ...
            <?php if($ttr->exam_id): ?>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label font-weight-semibold">Date d'Examen <span
                                class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input autocomplete="off" name="exam_date" value="<?php echo e(old('exam_date')); ?>" required type="text" class="form-control date-pick" placeholder="Sélectionner une date...">
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <select data-placeholder="Sélectionner un créneau..." required class="select form-control" name="ts_id"
                            id="ts_id">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary">✅ Ajouter la Matière <i class="icon-paperplane ml-2"></i></button>
            </div>
        </form>
    </div>

</div>
<?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/timetables/subjects/add.blade.php ENDPATH**/ ?>
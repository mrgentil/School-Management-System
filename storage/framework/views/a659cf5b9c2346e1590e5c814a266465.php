...
<body>
    ...
    <div class="bulletin-container">
        ...
        <div class="info-section">
            <div class="info-left">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($school['province'] ?? 'KINSHASA'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">VILLE :</span>
                    <span class="info-value"><?php echo e($school['city'] ?? ''); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">COMMUNE :</span>
                    <span class="info-value"><?php echo e($school['commune'] ?? ''); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">ECOLE :</span>
                    <span class="info-value"><?php echo e($school['name'] ?? config('app.name')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">CODE :</span>
                    <span class="info-value"><?php echo e($school['code'] ?? ''); ?></span>
                </div>
            </div>
            <div class="info-right">
                <div class="info-row">
                    <span class="info-label">ELEVE :</span>
                    <span class="info-value"><?php echo e($student->user->name ?? ''); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">SEXE :</span>
                    <span class="info-value"><?php echo e($student->user->gender == 'Male' ? 'M' : ($student->user->gender == 'Female' ? 'F' : ($student->user->gender ?? ''))); ?></span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($student->user->dob ? \Carbon\Carbon::parse($student->user->dob)->format('d/m/Y') : ''); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">CLASSE :</span>
                    <span class="info-value"><?php echo e($studentRecord->my_class->full_name ?? $studentRecord->my_class->name ?? ''); ?> <?php echo e($studentRecord->section->name ?? ''); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">N° PERM. :</span>
                    <span class="info-value"><?php echo e($studentRecord->adm_no ?? ''); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p class="code-ref">Document généré le <?php echo e(now()->format('d/m/Y à H:i')); ?></p>
        </div>
    </div>

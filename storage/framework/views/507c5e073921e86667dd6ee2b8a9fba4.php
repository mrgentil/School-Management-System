                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold"><?php echo e(($tt->exam_date ? 'Examen ('.date('D\, d/m/Y', strtotime($tt->exam_date)).')' : $tt->day)); ?> <?php echo e(($tt->time_slot ? '('.$tt->time_slot->full.')' : '(Créneau supprimé)') .' - '.$tt->subject->name); ?></h6>
                                <div class="header-elements">
                                    <div class="list-icons">
                                        <a onclick="confirmDelete(this.id)" href="#" id="<?php echo e($tt->id); ?>" title="SUPPRIMER"
...
<?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/timetables/subjects/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page_title', 'Paiements des Étudiants'); ?>
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="<?php echo e(route('payments.invoice', [Qs::hash($s->user_id)])); ?>" class="dropdown-item">Tous les Paiements</a>
                                <?php $__currentLoopData = \App\Helpers\Pay::getYears($s->user_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $py): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($py): ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/payments/manage.blade.php ENDPATH**/ ?>
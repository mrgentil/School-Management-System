...
<?php $__env->startSection('page_title', 'Analytics Avancés - Examens'); ?>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-right">
                            <a href="<?php echo e(route('exam_analytics.dashboard')); ?>" class="btn btn-light btn-lg">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?php echo e(route('exam_analytics.dashboard')); ?>" class="btn btn-outline-primary btn-block mb-2">
                                <i class="icon-stats-dots mr-2"></i>Dashboard Interactif
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo e(route('exam_analytics.struggling_students')); ?>" class="btn btn-outline-danger btn-block mb-2">
                                <i class="icon-user-minus mr-2"></i>Étudiants en Difficulté
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo e(route('exam_analytics.rankings')); ?>" class="btn btn-outline-success btn-block mb-2">
                                <i class="icon-trophy mr-2"></i>Classements & Palmarès
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo e(route('exam_analytics.historical_comparison')); ?>" class="btn btn-outline-info btn-block mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?php echo e(route('exam_analytics.subject_teacher_reports')); ?>" class="btn btn-outline-warning btn-block">
                                    ...
                                    <div class="card border-left-3 border-left-primary">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <h6 class="font-weight-bold mb-0"><?php echo e($exam->name); ?></h6>
                                                <span class="badge badge-primary">S<?php echo e($exam->semester); ?></span>
                                            </div>
                                            <p class="text-muted mb-2">
                                                <i class="icon-calendar mr-1"></i><?php echo e($exam->year); ?>

                                                <i class="icon-clock ml-2 mr-1"></i><?php echo e($exam->created_at->diffForHumans()); ?>
                                            ...
                                            <div class="row text-center mb-3">
                                                <div class="col-6">
                                                    ...
                                                    <div class="font-weight-bold"><?php echo e($studentsCount); ?></div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="font-size-sm text-muted">Moyenne</div>
                                                    <div class="font-weight-bold text-<?php echo e($avgScore >= 70 ? 'success' : ($avgScore >= 50 ? 'warning' : 'danger')); ?>">
                                                        <?php echo e($avgScore ? round($avgScore, 1) : 'N/A'); ?>%
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div class="btn-group btn-group-sm d-flex">
                                                <a href="<?php echo e(route('exam_analytics.overview', $exam->id)); ?>" class="btn btn-primary">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?php echo e(route('marks.tabulation', [$exam->id])); ?>">
                                                            <i class="icon-table2 mr-2"></i>Tabulation
                                                        </a>
                                                        <a class="dropdown-item" href="<?php echo e(route('marks.batch_fix')); ?>">
                                                            <i class="icon-wrench mr-2"></i>Correction Lot
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="#" onclick="exportExamResults(<?php echo e($exam->id); ?>)">
                                    ...
                                    <div class="card border-left-3 border-left-info">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h6 class="font-weight-bold mb-0"><?php echo e($class->name); ?></h6>
                                                <?php
                                                    $classStudents = \App\Models\StudentRecord::where('my_class_id', $class->id)
                                                        ->where('session', Qs::getSetting('current_session'))->count();
                                                ?>
                                                <span class="badge badge-info"><?php echo e($classStudents); ?> élèves</span>
                                            </div>
                                                ...
                                                <select class="form-control form-control-sm" onchange="if(this.value) window.location.href=this.value">
                                                    ...
                                                    <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(route('exam_analytics.class_analysis', [$exam->id, $class->id])); ?>">
                                                            <?php echo e($exam->name); ?> (S<?php echo e($exam->semester); ?>)
                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="btn-group btn-group-sm d-flex">
                                                <button type="button" class="btn btn-outline-info" onclick="showClassStats(<?php echo e($class->id); ?>)">
                                                    <i class="icon-stats-bars mr-1"></i>Statistiques
                                                </button>
                                                <button type="button" class="btn btn-outline-primary" onclick="showClassProgress(<?php echo e($class->id); ?>)">
...
<?php echo $__env->make('pages.support_team.exam_analytics.modals.import_marks', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('pages.support_team.exam_analytics.modals.export_results', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('pages.support_team.exam_analytics.modals.notify_parents', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
function exportExamResults(examId) {
    ...
    form.method = 'POST';
    form.action = '<?php echo e(route("exam_analytics.export_results")); ?>';

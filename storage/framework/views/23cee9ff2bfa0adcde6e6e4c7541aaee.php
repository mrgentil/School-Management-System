            ...
            <div class="demo-container" style="max-width: 800px; width: 100%;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'admin')); ?>" class="btn btn-outline-primary btn-block p-3 demo-card h-100 text-decoration-none">
                    ...
                    <!-- Teacher -->
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'teacher')); ?>" class="btn btn-outline-success btn-block p-3 demo-card h-100 text-decoration-none">
                            <div class="demo-icon mb-2">
                    ...
                    <!-- Student -->
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'student')); ?>" class="btn btn-outline-info btn-block p-3 demo-card h-100 text-decoration-none">
                            <div class="demo-icon mb-2">
                    ...
                    <!-- Parent -->
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'parent')); ?>" class="btn btn-outline-warning btn-block p-3 demo-card h-100 text-decoration-none">
                            <div class="demo-icon mb-2">
                    ...
                    <!-- Accountant -->
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'accountant')); ?>" class="btn btn-outline-danger btn-block p-3 demo-card h-100 text-decoration-none">
                            <div class="demo-icon mb-2">
                    ...
                    <!-- Librarian -->
                    <div class="col-md-4 col-sm-6 mb-3">
                        <a href="<?php echo e(route('demo.login', 'librarian')); ?>" class="btn btn-outline-secondary btn-block p-3 demo-card h-100 text-decoration-none">
                            <div class="demo-icon mb-2">
...
<?php echo $__env->make('layouts.login_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\eschool\resources\views/auth/demo.blade.php ENDPATH**/ ?>
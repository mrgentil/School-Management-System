...
<div class="row">
    <div class="col-sm-6 col-xl-3 card-animated fade-in-up">
        <div class="card card-body gradient-blue stat-card position-relative">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h3 class="mb-0 text-white counter-value" data-target="<?php echo e($stats['total_students']); ?>">0</h3>
    ...
    <div class="col-sm-6 col-xl-3 card-animated fade-in-up">
        <div class="card card-body gradient-green stat-card position-relative">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h3 class="mb-0 text-white counter-value" data-target="<?php echo e($stats['total_teachers']); ?>">0</h3>
    ...
    <div class="col-sm-6 col-xl-3 card-animated fade-in-up">
        <div class="card card-body gradient-orange stat-card position-relative">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h3 class="mb-0 text-dark counter-value" data-target="<?php echo e($stats['total_classes']); ?>">0</h3>
    ...
    <div class="col-sm-6 col-xl-3 card-animated fade-in-up">
        <div class="card card-body gradient-purple stat-card position-relative">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h3 class="mb-0 text-dark counter-value" data-target="<?php echo e($stats['total_staff']); ?>">0</h3>
        ...
        <div class="card border-left-3 border-left-primary">
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0"><?php echo e($stats['total_students']); ?></h6>
        ...
        <div class="card border-left-3 border-left-success">
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0"><?php echo e($payments_count); ?></h6>
        ...
        <div class="card border-left-3 border-left-warning">
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0"><?php echo e($stats['total_classes']); ?></h6>
        ...
        <div class="card border-left-3 border-left-danger">
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0"><?php echo e(count($upcoming_events ?? [])); ?></h6>
                    ...
                    callbacks: {
                        label: function(context) {
                            ...
                            if (context.parsed.y !== null) {
                                label += '<?php echo e(Qs::getCurrency()); ?> ' + new Intl.NumberFormat().format(context.parsed.y);
                            }
                            return label;
                        }
                    }
                ...
                y: {
                    ...
                    ticks: {
                        callback: function(value) {
                            return '<?php echo e(Qs::getCurrency()); ?> ' + value.toLocaleString();
                        }
                    }
                },
                x: {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\eschool\resources\views/pages/super_admin/dashboard.blade.php ENDPATH**/ ?>
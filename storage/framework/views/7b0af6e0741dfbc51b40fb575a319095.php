...
<div class="row">
    ...
    <div class="col-sm-6 col-xl-2">
        <div class="card card-body bg-success has-bg-image">
            <div class="media">
                <div class="media-body">
                    <h3 class="mb-0"><?php echo e($stats['total_parents']); ?></h3>
    ...
    <div class="col-sm-6 col-xl-2">
        <div class="card card-body bg-indigo has-bg-image">
            <div class="media">
                <div class="media-body">
                    <h3 class="mb-0"><?php echo e($stats['active_exams']); ?></h3>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="alert alert-<?php echo e($alert['type']); ?> d-flex align-items-center">
                        <i class="<?php echo e($alert['icon']); ?> mr-2"></i>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $topStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-<?php echo e($student['average'] >= 14 ? 'success' : ($student['average'] >= 10 ? 'warning' : 'danger')); ?>">
                                        <?php echo e($student['average']); ?>/20
                                    </span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('students.create')); ?>" class="btn btn-outline-primary btn-block">
                            <i class="icon-user-plus d-block mb-1" style="font-size: 24px;"></i>
                            Nouvel Élève
                        </a>
                    </div>
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('bulletins.index')); ?>" class="btn btn-outline-success btn-block">
                            <i class="icon-file-text d-block mb-1" style="font-size: 24px;"></i>
                            Bulletins
                        </a>
                    </div>
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('marks.index')); ?>" class="btn btn-outline-info btn-block">
                            <i class="icon-pencil d-block mb-1" style="font-size: 24px;"></i>
                            Notes
                        </a>
                    </div>
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-outline-warning btn-block">
                            <i class="icon-calendar d-block mb-1" style="font-size: 24px;"></i>
                            Présences
                        </a>
                    </div>
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('exams.index')); ?>" class="btn btn-outline-danger btn-block">
                            <i class="icon-clipboard3 d-block mb-1" style="font-size: 24px;"></i>
                            Examens
                        </a>
                    </div>
                    <div class="col-md-2 col-6 mb-3">
                        <a href="<?php echo e(route('whatsapp.test')); ?>" class="btn btn-outline-secondary btn-block">
...
<script>
    ...
    const studentsByClass = <?php echo json_encode($studentsByClass, 15, 512) ?>;
    const genderData = <?php echo json_encode($studentsByGender, 15, 512) ?>;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\eschool\resources\views/pages/support_team/dashboard_enhanced.blade.php ENDPATH**/ ?>
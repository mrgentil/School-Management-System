    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('tt.download_template', $ttr_id)); ?>" class="btn btn-primary btn-block">
                        <i class="icon-download4 mr-2"></i>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('tt.import', $ttr_id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('tt.export', $ttr_id)); ?>" class="btn btn-info">
                        <i class="icon-file-excel mr-2"></i>
                        Exporter vers Excel
                    </a>
                </div>
...
<?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/timetables/import_excel.blade.php ENDPATH**/ ?>
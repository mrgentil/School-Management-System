    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-4"><h6 class="card-title"><strong>Class: </strong> <?php echo e($my_class ? ($my_class->full_name ?: $my_class->name) : 'N/A'); ?></h6></div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/timetables/show.blade.php ENDPATH**/ ?>
...
<div class="modal fade" id="exportResultsModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('exam_analytics.export_results')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/exam_analytics/modals/export_results.blade.php ENDPATH**/ ?>
<?php $__env->startSection('page_title', 'Détails de la Demande'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h6 class="card-title">Demande #<?php echo e($request->id); ?></h6>
                <div class="header-elements">
                    <a href="<?php echo e(route('librarian.book-requests.index')); ?>" class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <ul class="list list-unstyled mb-0">
                            <li><strong>Nom :</strong> <?php echo e($request->student->user->name ?? 'N/A'); ?></li>
                            <li><strong>Email :</strong> <?php echo e($request->student->user->email ?? 'N/A'); ?></li>
                            <?php if($request->student && $request->student->my_class): ?>
                                <li><strong>Classe :</strong> <?php echo e($request->student->my_class->name ?? 'N/A'); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list list-unstyled mb-0">
                            <li><strong>Titre :</strong> <?php echo e($request->book->name ?? 'N/A'); ?></li>
                            <li><strong>Auteur :</strong> <?php echo e($request->book->author ?? 'N/A'); ?></li>
                            <li><strong>Disponible :</strong> 
                                <?php if($request->book && $request->book->available): ?>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <ul class="list list-unstyled mb-0">
                            <li><strong>Date de demande :</strong> <?php echo e($request->request_date ? \Carbon\Carbon::parse($request->request_date)->format('d/m/Y') : 'N/A'); ?></li>
                            ...
                            <?php if($request->expected_return_date): ?>
                                <li><strong>Date de retour prévue :</strong> <?php echo e(\Carbon\Carbon::parse($request->expected_return_date)->format('d/m/Y')); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <p><?php echo e($request->remarks); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="list list-unstyled mb-0">
                            <li><strong>Traité par :</strong> ID <?php echo e($request->approved_by); ?></li>
                        </ul>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php if($request->status == 'approved'): ?>
                    ...
                    <form action="<?php echo e(route('librarian.book-requests.mark-borrowed', $request->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <?php if($request->status == 'borrowed'): ?>
                    ...
                    <!-- Envoyer un rappel -->
                    <form action="<?php echo e(route('librarian.book-requests.send-reminder', $request->id)); ?>" method="POST" class="mt-2">
                        <?php echo csrf_field(); ?>
...
<div id="approveModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('librarian.book-requests.approve', $request->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="date" name="expected_return_date" class="form-control" required min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
                    </div>
                    <div class="form-group">
...
<div id="rejectModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('librarian.book-requests.reject', $request->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eschool\resources\views/pages/librarian/book_requests/show.blade.php ENDPATH**/ ?>
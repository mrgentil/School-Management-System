<div class="card">
    <div class="card-header">
        <h4 class="card-title">
            ...
            Proclamation Semestre <?php echo e($semester); ?> - <?php echo e($selected_class->full_name ?: $selected_class->name); ?>
    ...
    <div class="card-body">
        <?php if($rankings['total_students'] > 0): ?>
            ...
            <div class="alert alert-info mb-4">
                ...
                <strong>Semestre <?php echo e($semester); ?></strong> : 
                Moyenne des périodes <?php echo e($semester == 1 ? '1 et 2' : '3 et 4'); ?> (40%) + Examens semestre <?php echo e($semester); ?> (60%)
            </div>
                            ...
                            <tr class="<?php echo e($ranking['rank'] <= 3 ? 'table-warning' : ''); ?>">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-outline-info" 
                                            onclick="showStudentDetail(<?php echo e($ranking['student_id']); ?>, '<?php echo e($ranking['student_name']); ?>', 'semester', <?php echo e($semester); ?>)">
                                        <i class="icon-eye"></i>
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <button class="btn btn-outline-primary" onclick="exportToPDF('semester', <?php echo e($semester); ?>)">
        ...
        <?php else: ?>
            <div class="alert alert-warning">
                ...
                Aucun étudiant trouvé avec des notes pour ce semestre.
                <br>
                <small>Vérifiez que les notes de périodes et d'examens ont été saisies et que les cotes sont configurées pour cette classe.</small>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<?php /**PATH C:\laragon\www\eschool\resources\views/pages/support_team/proclamations/semester_rankings.blade.php ENDPATH**/ ?>